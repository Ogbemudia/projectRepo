$(document).ready(function() {
    ...
    $.fn.category = function() {
            ...
            categoryTable = `<div class="container-fluid col-12 containertable">
            <div class="table-responsive" style="box-shadow: 10px 10px 20px #2a2e33; padding: 2%;">
                ...
                <footer>
                    <button type="button" class="btn btn-danger btn-sm" id="close" title="Close Category"><i class="fa fa-times" aria-hidden="true"></i></button>  
                    <button type="button" class="btn btn-success btn-sm" id="addcategory" style="float:right" title="Add New Category"><i class="fa fa-plus" aria-hidden="true"></i></button>       
                                <i class="userid"></i>
                </footer>
              </div>
            </div>`;
            ...
            $('#allItems').html(categoryTable);
            $('#nameId').html('Categories');
            $('#titleItem').html('Categories');
                ...
                $.each(messages, function(i, messages) {
                    ...
                    bookInfo = ` <tr>
                                    <td style="color: #0492C2;" class = "uid1">` + Id + `</td>
                                                    ...
                                                    <button type="button" class=" btn-primary btn-sm che btntb1" id="che" data-value='` + messages.category + `' value='` + Id + `' title="Update Category"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button>
                                                    <button type="button" class=" btn-danger btn-sm delete1 btntb1" data-value='` + messages.category + `' value='` + Id + `' title="Delete Category"><i class="fa fa-trash" aria-hidden="true"></i></button>
                                    </td>
                                </tr>`;
                    ...
                    $('.che').click(function() {
                        ID = $(this).val();
                        $.fn.updateCategory(ID);
                    });

                    $('.delete1').click(function() {
                        ID = $(this).val();
                        title1 = $(this).data('value');
                        $.fn.deleteCategory(ID, title1);
                    });
    ...
    $.fn.addCategory = function() {
        ...
        var form1 = `<div class="wrapper">
                ...
                <form onsubmit="return false;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control" placeholder="Book Category " id="name">
        ...
        $("form").submit(function(e) {
            ...
            if ($("#name").val() == '') {
                ...
                $("#h_name").html('Enter Category');
                return false;
            } else {
                $("#name").css('border', '2px solid green');
                $("#h_name").html('');
                var postCategory = $("#name").val();
                //return true;
            };
    ...
    $.fn.updateCategory = function() {
            ...
            $.get("../api/read_singlecategory.php?id=" + sid, function(messages) {
                id = messages.id;
                title1 = messages.category;
                ...
                $("form").submit(function(e) {
                    ...
                    if ($("#tittle").val() == '') {
                        ...
                        $("#h_tittle").html('Enter Category');
                        return false;
                    } else {
                        $("#tittle").css('border', '2px solid green');
                        $("#h_tittle").html('');
                        postCategory = $("#tittle").val();
                        //return true;
                    };
    ...
    $.fn.deleteCategory = function() {
            ...
            var modalPop = `<div class="popup-overlay active" id="delete21" style="height:15%; width:45%; border:red solid 1px;">
                    <div class="popup-link active" style="height:70%;">
                        <p style="height:60%;padding:2%;">Are you sure you want to delete <b><span class="del_acc">` + title2 + `</span></b> Category?</p>
